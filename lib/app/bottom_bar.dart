...
import 'package:mentaura_app/features/auth/application/user.auth.provider.dart';
...
class BottomBar extends ConsumerWidget {
  ...
  static final _screens = [HomeScreen(), MoodHistoryScreen(), ProfileScreen()];
